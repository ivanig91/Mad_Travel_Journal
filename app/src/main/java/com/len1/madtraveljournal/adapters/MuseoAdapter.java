...
public class MuseoAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<LugarMuseo> listaLugar;
    private LayoutInflater inflater;

    public MuseoAdapter(Context context, ArrayList<LugarMuseo> listaLugar) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LugarMuseo lugar = listaLugar.get(position);
