...
public class MonumentoAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<LugarMonumento> listaLugar;
    private LayoutInflater inflater;

    public MonumentoAdapter(Context context, ArrayList<LugarMonumento> listaLugar) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LugarMonumento lugar = listaLugar.get(position);
